...
describe('Transferencias', () => {
    ...
    describe ('POST /transferencias', () => {
        ...
        it ('Deve retornar com 201 quando o valor da transferência for igual ou acima de R$ 10,00', async () => {           
    ...
    describe ('GET /transferencias', () => {
        it('Deve retornar elementos na paginacao quando informar limite de 10 registros', async () => {
            const resposta = await request(process.env.BASE_URL)
